...
// import { dislikeGame, likeGame } from '@/lib/controllers/like'
...
//                 <Button onClick={async () => {user ? likeGame(game.id, user.id): toast('Sign In to like games')}} variant="outline" size="icon" className="text-black bg-white hover:bg-purple-700 hover:text-white">
//                   <ThumbsUp className="h-5 w-5" />
//                 </Button>
//                 <Button onClick={async () => {user ? dislikeGame(game.id, user.id): toast('Sign In to dislike games')}} variant="outline" size="icon" className="text-black bg-white hover:bg-purple-700 hover:text-white">
