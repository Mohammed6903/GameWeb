    ...
    <div className='bg-gradient-to-br from-purple-600 to-purple-800 w-full h-14 border-t'>
        <div className="max-w-7xl mx-auto flex justify-between items-center px-4 py-2">
            ...
            <div className='text-white flex items-center gap-6'>
                ...
                <Link href="/about" className='flex items-center gap-2 hover:text-purple-300'>
                    <Info className='w-5 h-5' />
                    <span className='text-base font-medium'>About Us</span>
                </Link>
                <Link href="/contact" className='flex items-center gap-2 hover:text-purple-300'>
                    <Phone className='w-5 h-5' />
                    <span className='text-base font-medium'>Contact</span>
                </Link>
                <Link href="/dmca" className='flex items-center gap-2 hover:text-purple-300'>
                    <Shield className='w-5 h-5' />
                    <span className='text-base font-medium'>DMCA</span>
                </Link>
                <Link href="/privacy-policy" className='flex items-center gap-2 hover:text-purple-300'>
                    <FileText className='w-5 h-5' />
                    <span className='text-base font-medium'>Privacy Policy</span>
                </Link>
                <Link href="/terms" className='flex items-center gap-2 hover:text-purple-300'>
                    <FileText className='w-5 h-5' />
                    <span className='text-base font-medium'>Terms of Service</span>
                </Link>
                <Link href="/powered-by" className='flex items-center gap-2 hover:text-purple-300'>
